...
///////////////////////////////////////////////////Return sucessful////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
std::cout<<"Results OK, "<<Name[0]<<" "<<Name[1]<<" "<<accNum;//Reurn sucessful with users name
}
...
string accountNumber(){
  ...
  /*if(11==accNum.length())
    ...
    //IF the validity hasnt been disproven yet, break the while loop.
  }
  cout<<"WORKED";
return acounNum;
}
